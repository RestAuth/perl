...
RestAuth::Error::PreconditionFailed - Thrown when the provided data violates local policy

=head1 DESCRIPTION

Thrown when the provided data violates some local policy of the RestAuth server.
Prominent examples are a username or password that is to short or a username
