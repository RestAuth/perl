...
RestAuth::Error::UnknownStatus - RestAuth server returned an unknown status

=head1 DESCRIPTION

This exception is thrown when the RestAuth server returned an HTTP status where
the library does not know the meaning of. If you ever catch this exception, this
usually hints at a bug in either this library or the server implementation.
